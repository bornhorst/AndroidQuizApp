 ...
 * Class: QuizActivity8
 *
 * Description: Launches the eighth question for a selected quiz.
 *
 * Date: 5-7-2019
 *
 */
public class QuizActivity8 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.choiceOne = findViewById(R.id.quiz8_choiceOne);
        this.choiceTwo = findViewById(R.id.quiz8_choiceTwo);
        this.choiceThree = findViewById(R.id.quiz8_choiceThree);
        this.choiceFour = findViewById(R.id.quiz8_choiceFour);
        this.startQuiz = findViewById(R.id.quiz8_button);
        this.quizQuestion = findViewById(R.id.quiz8_question);
        ...
        try {
            ...
            String question = jsonLoader.setupJSONString("question8");
            this.quizAnswer = jsonLoader.setupJSONString("answer8");
            ArrayList<String> choices = jsonLoader.setupJSONArray("choices8", "choice");
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()) {
            ...
            case R.id.cheat_button:
                ...
                break;
            case R.id.quiz8_button:
                // send the boolean result/cheat value to the next activity
                // along with any previous activities results
                intent.putExtras(getIntent().getExtras());
                intent.putExtra("Cheater8", this.wasCheated);
                intent.putExtra("wasCorrect8", this.correctAnswer);
