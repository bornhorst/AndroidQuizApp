 ...
 * Class: QuizActivity3
 *
 * Description: Launches the third question for a selected quiz.
 *
 * Date: 5-7-2019
 *
 */
public class QuizActivity3 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.choiceOne = findViewById(R.id.quiz3_choiceOne);
        this.choiceTwo = findViewById(R.id.quiz3_choiceTwo);
        this.choiceThree = findViewById(R.id.quiz3_choiceThree);
        this.choiceFour = findViewById(R.id.quiz3_choiceFour);
        this.startQuiz = findViewById(R.id.quiz3_button);
        this.quizQuestion = findViewById(R.id.quiz3_question);
        ...
        try {
            ...
            String question = jsonLoader.setupJSONString("question3");
            this.quizAnswer = jsonLoader.setupJSONString("answer3");
            ArrayList<String> choices = jsonLoader.setupJSONArray("choices3", "choice");
    ...
    public void onClick(View v) {
        ...
        final Intent intent = new Intent(this, QuizActivity4.class);
        ...
        switch(v.getId()) {
            ...
            case R.id.cheat_button:
                ...
                break;
            case R.id.quiz3_button:
                // send the boolean result/cheat value to the next activity
                // along with any previous activities results
                intent.putExtras(getIntent().getExtras());
                intent.putExtra("Cheater3", this.wasCheated);
                intent.putExtra("wasCorrect3", this.correctAnswer);
