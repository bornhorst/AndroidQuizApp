 ...
 * Class: QuizActivity4
 *
 * Description: Launches the fourth question for a selected quiz.
 *
 * Date: 5-7-2019
 *
 */
public class QuizActivity4 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.choiceOne = findViewById(R.id.quiz4_choiceOne);
        this.choiceTwo = findViewById(R.id.quiz4_choiceTwo);
        this.choiceThree = findViewById(R.id.quiz4_choiceThree);
        this.choiceFour = findViewById(R.id.quiz4_choiceFour);
        this.startQuiz = findViewById(R.id.quiz4_button);
        this.quizQuestion = findViewById(R.id.quiz4_question);
        ...
        try {
            ...
            String question = jsonLoader.setupJSONString("question4");
            this.quizAnswer = jsonLoader.setupJSONString("answer4");
            ArrayList<String> choices = jsonLoader.setupJSONArray("choices4", "choice");
    ...
    public void onClick(View v) {
        ...
        final Intent intent = new Intent(this, QuizActivity5.class);
        ...
        switch(v.getId()) {
            ...
            case R.id.cheat_button:
                ...
                break;
            case R.id.quiz4_button:
                // send the boolean result/cheat value to the next activity
                // along with any previous activities results
                intent.putExtras(getIntent().getExtras());
                intent.putExtra("Cheater4", this.wasCheated);
                intent.putExtra("wasCorrect4", this.correctAnswer);
