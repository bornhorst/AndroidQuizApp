 ...
 * Class: QuizActivity1
 *
 * Description: Launches the first question for a selected quiz.
 *
 * Date: 5-7-2019
 *
 */
public class QuizActivity1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.choiceOne = findViewById(R.id.quiz1_choiceOne);
        this.choiceTwo = findViewById(R.id.quiz1_choiceTwo);
        this.choiceThree = findViewById(R.id.quiz1_choiceThree);
        this.choiceFour = findViewById(R.id.quiz1_choiceFour);
        this.startQuiz = findViewById(R.id.quiz1_button);
        this.quizQuestion = findViewById(R.id.quiz1_question);
        ...
        try {
            ...
            String question = jsonLoader.setupJSONString("question1");
            this.quizAnswer = jsonLoader.setupJSONString("answer1");
            ArrayList<String> choices = jsonLoader.setupJSONArray("choices1", "choice");
    ...
    public void onClick(View v) {
        ...
        final Intent intent = new Intent(this, QuizActivity2.class);
        ...
        switch(v.getId()) {
            ...
            case R.id.cheat_button:
                ...
                break;
            case R.id.quiz1_button:
                // send the boolean result/cheat value to the next activity
                // along with any previous activities results
                intent.putExtras(getIntent().getExtras());
                intent.putExtra("Cheater1", this.wasCheated);
                intent.putExtra("wasCorrect1", this.correctAnswer);
