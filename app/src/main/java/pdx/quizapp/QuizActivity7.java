 ...
 * Class: QuizActivity7
 *
 * Description: Launches the seventh question for a selected quiz.
 *
 * Date: 5-7-2019
 *
 */
public class QuizActivity7 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.choiceOne = findViewById(R.id.quiz7_choiceOne);
        this.choiceTwo = findViewById(R.id.quiz7_choiceTwo);
        this.choiceThree = findViewById(R.id.quiz7_choiceThree);
        this.choiceFour = findViewById(R.id.quiz7_choiceFour);
        this.startQuiz = findViewById(R.id.quiz7_button);
        this.quizQuestion = findViewById(R.id.quiz7_question);
        ...
        try {
            ...
            String question = jsonLoader.setupJSONString("question7");
            this.quizAnswer = jsonLoader.setupJSONString("answer7");
            ArrayList<String> choices = jsonLoader.setupJSONArray("choices7", "choice");
    ...
    public void onClick(View v) {
        ...
        final Intent intent = new Intent(this, QuizActivity8.class);
        ...
        switch(v.getId()) {
            ...
            case R.id.cheat_button:
                ...
                break;
            case R.id.quiz7_button:
                // send the boolean result/cheat value to the next activity
                // along with any previous activities results
                intent.putExtras(getIntent().getExtras());
                intent.putExtra("Cheater7", this.wasCheated);
                intent.putExtra("wasCorrect7", this.correctAnswer);
