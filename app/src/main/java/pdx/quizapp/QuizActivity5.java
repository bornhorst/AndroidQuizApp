 ...
 * Class: QuizActivity5
 *
 * Description: Launches the fifth question for a selected quiz.
 *
 * Date: 5-7-2019
 *
 */
public class QuizActivity5 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.choiceOne = findViewById(R.id.quiz5_choiceOne);
        this.choiceTwo = findViewById(R.id.quiz5_choiceTwo);
        this.choiceThree = findViewById(R.id.quiz5_choiceThree);
        this.choiceFour = findViewById(R.id.quiz5_choiceFour);
        this.startQuiz = findViewById(R.id.quiz5_button);
        this.quizQuestion = findViewById(R.id.quiz5_question);
        ...
        try {
            ...
            String question = jsonLoader.setupJSONString("question5");
            this.quizAnswer = jsonLoader.setupJSONString("answer5");
            ArrayList<String> choices = jsonLoader.setupJSONArray("choices5", "choice");
    ...
    public void onClick(View v) {
        ...
        final Intent intent = new Intent(this, QuizActivity6.class);
        ...
        switch(v.getId()) {
            ...
            case R.id.cheat_button:
                ...
                break;
            case R.id.quiz5_button:
                // send the boolean result/cheat value to the next activity
                // along with any previous activities results
                intent.putExtras(getIntent().getExtras());
                intent.putExtra("Cheater5", this.wasCheated);
                intent.putExtra("wasCorrect5", this.correctAnswer);
