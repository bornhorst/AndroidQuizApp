 ...
 * Class: QuizActivity2
 *
 * Description: Launches the second question for a selected quiz.
 *
 * Date: 5-7-2019
 *
 */
public class QuizActivity2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.choiceOne = findViewById(R.id.quiz2_choiceOne);
        this.choiceTwo = findViewById(R.id.quiz2_choiceTwo);
        this.choiceThree = findViewById(R.id.quiz2_choiceThree);
        this.choiceFour = findViewById(R.id.quiz2_choiceFour);
        this.startQuiz = findViewById(R.id.quiz2_button);
        this.quizQuestion = findViewById(R.id.quiz2_question);
        ...
        try {
            ...
            String question = jsonLoader.setupJSONString("question2");
            this.quizAnswer = jsonLoader.setupJSONString("answer2");
            ArrayList<String> choices = jsonLoader.setupJSONArray("choices2", "choice");
    ...
    public void onClick(View v) {
        ...
        final Intent intent = new Intent(this, QuizActivity3.class);
        ...
        switch(v.getId()) {
            ...
            case R.id.cheat_button:
                ...
                break;
            case R.id.quiz2_button:
                // send the boolean result/cheat value to the next activity
                // along with any previous activities results
                Log.d("ButtonPressed", "YES");
                intent.putExtras(getIntent().getExtras());
                intent.putExtra("Cheater2", this.wasCheated);
                intent.putExtra("wasCorrect2", this.correctAnswer);
